(define (problem ricorico-ext2-generado)
  ...
  (:init
    ...
    (es-tipo-primero primero1 tipo3)
    (es-tipo-primero primero2 tipo4)
    (es-tipo-primero primero3 tipo2)
    (es-tipo-primero primero4 tipo3)
    (es-tipo-primero primero5 tipo3)
    (es-tipo-primero primero6 tipo3)

    (es-tipo-segundo segundo1 tipo4)
    (es-tipo-segundo segundo2 tipo4)
    (es-tipo-segundo segundo3 tipo1)
    (es-tipo-segundo segundo4 tipo2)
    (es-tipo-segundo segundo5 tipo3)
    (es-tipo-segundo segundo6 tipo1)
  )
